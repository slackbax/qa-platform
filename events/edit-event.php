...
<section class="content container-fluid">
    <form role="form" id="formNewEvent">
        <div class="box box-default">
            ...
            <div class="box-body">
                <div class="row">
                    <div class="form-group col-xs-3" id="grut">
            ...
            <div class="box-body">
                ...
                <div class="row">
                    <div class="form-group col-xs-6" id="gstev">
                ...
                <div class="row">
                    <div class="form-group col-xs-6" id="grie">
                ...
                <div class="row">
                    <div class="form-group col-xs-12" id="gdescription">
                ...
                <div class="row">
                    <div class="form-group col-xs-6" id="gconsec">
                ...
                <div class="row">
                    <div class="form-group col-xs-3" id="gnocu">
                    ...
                    <div class="form-group col-xs-3" id="gcljus">
                ...
                <div class="row">
                    <div class="form-group col-xs-3" id="gmedp">
