<section class="content-header">
	<div class="callout callout-danger">
		...
		<a class="btn btn-default text-black" id="btnback"><i class="fa fa-undo"></i> Volver atrás</a> <a href="index.php" class="btn btn-info" id="btnback"><i class="fa fa-home"></i> Volver al inicio</a>
	</div>
</section>
