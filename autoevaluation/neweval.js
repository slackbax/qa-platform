$(document).ready(function () {
	...
	var options = {
		url: 'autoevaluation/ajax.insertAutoeval.php',
		type: 'post',
		dataType: 'json',
	...
	$('#iNtcode').change(function () {
		...
		if ($(this).val() !== '') {
			$.ajax({
				...
				var txt = '';
				txt += '<div class="box-header with-border"><h3 class="box-title">Detalles</h3></div>';
				txt += '<div class="box-body"><table class="table table-condensed">';
				txt += '<thead>' +
					'<tr>' +
					'<th>Descripción</th>' +
					'</tr>' +
