<section class="content-header">
	<h1>Capacitación
		<small><i class="fa fa-angle-right"></i> Capacitación COVID-19</small>
	</h1>

	<ol class="breadcrumb">
		<li><a href="index.php?section=home"><i class="fa fa-home"></i> Inicio</a></li>
		<li class="active">Capacitación relacionada a COVID-19</li>
	</ol>
</section>
...
<section class="content container-fluid">
	<div class="box box-default">
		<div class="box-header with-border">
			<h3 class="box-title">Documentos de Inducción</h3>
		</div>
...
<script src="covid/covid-index.js?v=20190828"></script>
