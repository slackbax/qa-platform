...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li <?php if (!isset($pvid) and !isset($tcid)): ?> class="active"<?php endif ?>><?php if (isset($pvid)): ?><a href="index.php?section=verif-points"><?php endif ?>Puntos de Verificación<?php if (isset($pvid)): ?></a><?php endif ?></li>
        <?php if (isset($pvid)): ?>
        <?php $pverif = $pv->get($pvid) ?>
        <li <?php if (isset($pvid) and !isset($tcid)): ?> class="active"<?php endif ?>><?php if (isset($tcid)): ?><a href="index.php?section=verif-points&pvid=<?php echo $pvid ?>"><?php endif ?><?php echo $pverif->pv_nombre ?><?php if (isset($tcid)): ?></a><?php endif ?></li>
        <?php endif ?>
        <?php if (isset($tcid)): ?>
...
<section class="content container-fluid">
    ...
    <?php if (isset($pvid) and !isset($tcid) and $pvid != 1): ?>
    <div class="box box-default">
        <div class="box-header with-border">
            ...
            <table id="tcaract" class="table table-hover table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $tc->getNumFilesByPV($pvid, $t->tcar_id) ?></td>
                    </tr>
                    <?php endforeach ?>
                </tbody>
            </table>
    ...
    <?php if (isset($tcid)): ?>
    <?php $n_f = $tc->getNumFilesByPV($pvid, $tcid) ?>
    <?php if ($n_f > 0): $file = $fl->getByCaractPV($pvid, $tcid); endif ?>
