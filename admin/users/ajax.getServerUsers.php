...
$columns = array(
    ...
    array('db' => 'us_id', 'dt' => 5, 'field' => 'us_id',
        'formatter' => function ($d, $row) {
            ...
            $string .= ' <a class="userEdit btn btn-xs btn-primary" href="index.php?section=users&sbs=edituser&id=' . $d . '" data-tooltip="tooltip" data-placement="top" title="Editar"><i class="fa fa-pencil"></i></a>';
