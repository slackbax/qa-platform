<section class="content-header">
	<h1>Panel de Control
		<small><i class="fa fa-angle-right"></i> Administración de Documentos</small>
	</h1>

	<ol class="breadcrumb">
		<li><a href="index.php?section=home"><i class="fa fa-home"></i>Inicio</a></li>
		<li class="active">Documentos ingresados</li>
	</ol>
</section>
...
<script src="admin/files/manage-files.js?v=20190828"></script>